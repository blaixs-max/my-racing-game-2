...
import { useAccount, useBalance, useConfig, useSwitchChain, useChainId, useReconnect } from 'wagmi';
...
const RealLauncherUI = ({ onStartGame }) => {
    ...
    const handleVisibilityChange = async () => {
      if (document.visibilityState === 'visible') {
        ...
        if (status === 'reconnecting' || status === 'connecting') {
           console.log('🔄 Revalidating connection...');
           // Trigger a re-render or wagmi will handle it automatically,
           // but logging helps debugging mobile issues.
        }

        // 2. Resume Pending Transaction Check
  ...
  }, [state.pendingTxHash, state.isProcessing, status]); // Dependencies updated
