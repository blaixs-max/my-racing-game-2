...
const VEHICLE_DIMENSIONS = {
  ...
  sedan: { width: 2.0, length: 4.8, height: 1.8 }, // Updated to match Car 1 GLTF dimensions
  ...
  suv: { width: 1.8, length: 3.7, height: 2.3 } // SUV (Restored)
};
        ...
        return (
          <group key={enemy.id} position={[x, 0, enemy.z]} rotation={[0, 0, tilt]}>
            ...
            {enemy.type === 'suv' && (
              <group rotation={[0, Math.PI, 0]}>
                {/* SUV: Car 2 */}
                <CarModel modelPath="/models/Car 2/scene.gltf" scale={1.0} />
              </group>
            )}
            {enemy.type === 'sedan' && (
              <group rotation={[0, Math.PI, 0]}>
                {/* Sedan: Car 1 */}
                <CarModel modelPath="/models/Car1/scene.gltf" scale={1.0} color="#aaaaaa" />
              </group>
            )}
            {enemy.type === 'police' && (
